 ...
 */
export const ConfigureRequestSchema: GenMessage<ConfigureRequest> = /*@__PURE__*/
 ...
 */
export const ConfigureResponseSchema: GenMessage<ConfigureResponse> = /*@__PURE__*/
  messageDesc(file_auth_v1_auth, 3);

/**
 * @generated from message auth.v1.SubscribeAuthEventsRequest
 */
export type SubscribeAuthEventsRequest = Message<"auth.v1.SubscribeAuthEventsRequest"> & {
};
 ...
 */
export const SubscribeAuthEventsRequestSchema: GenMessage<SubscribeAuthEventsRequest> = /*@__PURE__*/
