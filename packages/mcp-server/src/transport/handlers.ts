...
Key flags for 'issue view': -c/--comments (show comments, default: 20), -c=N (N comments), -c=all (all comments), --comments-order asc|desc, --comments-since ID. IMPORTANT: -c takes an optional value — always use '=' to pass a value (e.g., -c=all, -c=50). Do NOT use space-separated form (-c all).
