...
var operationRolesApiKey = map[string][]string{
	...
	GetCustomFieldsOperation:                 []string{},
	GetDocumentOperation:                     []string{},
	GetDocumentCommentsOperation:             []string{},
	GetDocumentTreeOperation:                 []string{},
	GetDocumentsOperation:                    []string{},
	GetDocumentsCountOperation:               []string{},
	GetIssueOperation:                        []string{},
	GetIssueTypesOperation:                   []string{},
	GetIssuesOperation:                       []string{},
	GetIssuesCountOperation:                  []string{},
	GetListOfIssueAttachmentsOperation:       []string{},
	GetListOfLinkedSharedFilesOperation:      []string{},
	GetListOfPullRequestAttachmentOperation:  []string{},
	GetListOfRecentlyViewedIssuesOperation:   []string{},
	GetListOfSharedFilesOnWikiOperation:      []string{},
	GetListOfWikiAttachmentsOperation:        []string{},
	GetPrioritiesOperation:                   []string{},
	...
	GetUserRecentUpdatesOperation:            []string{},
	...
	LinkSharedFilesToIssueOperation:          []string{},
	LinkSharedFilesToWikiOperation:           []string{},
	RemoveDocumentTagsOperation:              []string{},
	RemoveLinkToSharedFileFromIssueOperation: []string{},
	RemoveLinkToSharedFileFromWikiOperation:  []string{},
	RemoveWikiAttachmentOperation:            []string{},
